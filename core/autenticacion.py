...
UserPrincipal = "DBtwo.json"

ruta_carpeta = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "databas")

# Funcionn  para generar usuario y Contraseña Principal
def generar_Admin():
